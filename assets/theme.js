    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateSku(newVariant, previousVariant) {
        var productSku = this.element.querySelector('.product-meta__sku'),
            productSkuNumber = productSku.querySelector('.product-meta__sku-number');
      ...
      /**
       *  automatically adds a "disabled" state to sold out/unavailable variant. When we change the variant we have to recompute
       * all the selectors
       */
  ...
  */
  ...
  var SearchBar = /*#__PURE__*/function () {
    ...
    _createClass(SearchBar, [{
      ...
      /**
       *  allows to display a filter by type. When its value change, we re-do a new search to get the new data
       */
